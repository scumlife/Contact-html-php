...
<?php
    if (filter_input(INPUT_POST['verzenden'])) {
        if(mail($naar, $onderwerp, $bericht, $van)) {
            ...
            echo '<p>Sorry voor het ongemak, maar het blijkt dat er problemen zijn met het formulier dat u ons heeft gestuurd. Zou u het alstublieft opnieuw kunnen proberen.</p>';
        }
    }
?>